        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                ...
                <div class="pb-20 p-4">
                    ...
                    <form action="/dashboard/kegiatan/{{$data->id}}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('namaKegiatan')
                                form-control-danger
                            @enderror" type="text" name="namaKegiatan" value="{{$data->mamaKegiatan}}" placeholder="Kesehatan" required>
                            @error('namaKegiatan')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('tanggalKegiatan')
                                form-control-danger
                            @enderror" type="date" name="tanggalKegiatan" value="{{$data->tanggalKegiatan}}" placeholder="Kesehatan" required>
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                ...
                                <input class="form-control @error('jamMulai')
                                    form-control-danger
                                @enderror" type="time" name="jamMulai" value="{{$data->jamMulai}}" placeholder="Kesehatan" required>
                                @error('jamMulai')
                                    <div class="form-control-feedback text-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-6">
                                ...
                                <input class="form-control @error('jamAkhir')
                                    form-control-danger
                                @enderror" type="time" name="jamAkhir" value="{{$data->jamAkhir}}" placeholder="Kesehatan" required>
                                @error('jamAkhir')
                                    <div class="form-control-feedback text-danger">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height: 100px" name="lokasi">{{$data->lokasi}}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @error('deskripsi')
                                <div class="form-control-feedback text-danger">{{$message}}</div>
                            @enderror
                            <textarea id="editor"  name="deskripsiKegiatan">{{$data->deskripsiKegiatan}}</textarea>
