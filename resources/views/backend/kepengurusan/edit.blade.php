        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                ...
                <div class="pb-20 p-4">
                    ...
                    <form action="/dashboard/kepengurusan/{{$data->id}}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td>
                                    <div class="row mx-1">
                                        <input type="text" name="tahunMulai" value="{{$data->tahunMulai}}" placeholder="Tahun Awal Periode"
                                            class="form-control col-5 " style="margin-right: 10px ">
                                        <div class="col text-center"> Sampai </div>
                                        <input type="text" name="tahunAkhir" value="{{$data->tahunAkhir}}" placeholder="Tahun Akhir Periode"
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="select3" style="width: 100%" class="form-control " name="ketua">
                                        ...
                                        <option value="{{$item->id}}" {{$data->ketua == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                        @endforeach
                                    </select>
                                    @error('ketua')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="waket_1" style="width: 100%" class="form-control " name="waket_1">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->waket_1 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('waket_1')
                                    ...
                                    <div class="mb-2 ">
                                        <select id="waket_2" style="width: 100%" class="form-control " name="waket_2">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->waket_2 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('waket_2')
                                            <div class="form-control-feedback text-danger">Data Wakil Ketua Wajib Isi</div>
                                    ...
                                    <div class="mb-2">
                                        <select id="waket_3" style="width: 100%" class="form-control " name="waket_3">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->waket_3== $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('waket_3')
                                            <div class="form-control-feedback text-danger">Data Wakil Ketua Wajib Isi</div>
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="sekretaris" style="width: 100%" class="form-control "
                                            name="sekretaris">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->sekretaris == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('sekretaris')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="wasek_1" style="width: 100%" class="form-control "
                                            name="wasek_1">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->wasek_1 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('wasek_1')
                                    ...
                                    <div class="mb-2">
                                        <select id="wasek_2" style="width: 100%" class="form-control "
                                            name="wasek_2">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->wasek_2 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('wasek_2')
                                            <div class="form-control-feedback text-danger">Data Wakil Sekretaris Wajib Isi</div>
                                    ...
                                    <div class="mb-2">
                                        <select id="wasek_3" style="width: 100%" class="form-control "
                                            name="wasek_3">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->wasek_3 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('wasek_3')
                                            <div class="form-control-feedback text-danger">Data Wakil Sekretaris Wajib Isi</div>
                                    ...
                                    <div class="mb-2">
                                        <select id="wasek_4" style="width: 100%" class="form-control "
                                            name="wasek_4">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->wasek_4 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('wasek_4')
                                            <div class="form-control-feedback text-danger">Data Wakil Sekretaris Wajib Isi</div>
                                    ...
                                    <div class="mb-2">
                                        <select id="wasek_5" style="width: 100%" class="form-control "
                                            name="wasek_5">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->wasek_5 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('wasek_5')
                                            <div class="form-control-feedback text-danger">Data Wakil Sekretaris Wajib Isi</div>
                                    ...
                                    <div class="mb-2">
                                        <select id="wasek_6" style="width: 100%" class="form-control "
                                            name="wasek_6">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->wasek_6 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('wasek_6')
                                            <div class="form-control-feedback text-danger">Data Wakil Sekretaris Wajib Isi</div>
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="bendahara" style="width: 100%" class="form-control "
                                            name="bendahara">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->bendahara == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('bendahara')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="waben_1" style="width: 100%" class="form-control "
                                            name="waben_1">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->waben_1 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('waben_1')
                                    ...
                                    <div class="mb-2">
                                        <select id="waben_2" style="width: 100%" class="form-control "
                                            name="waben_2">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->waben_2 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('waben_2')
                                            <div class="form-control-feedback text-danger">Data Wakil Bendahara Wajib Isi</div>
                                    ...
                                    <div class="mb-2">
                                        <select id="waben_3" style="width: 100%" class="form-control "
                                            name="waben_3">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->waben_3 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('waben_3')
                                            <div class="form-control-feedback text-danger">Data Wakil Bendahara Wajib Isi</div>
                                    ...
                                    <div class="mb-2">
                                        <select id="waben_4" style="width: 100%" class="form-control "
                                            name="waben_4">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->waben_4 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('waben_4')
                                            <div class="form-control-feedback text-danger">Data Wakil Bendahara Wajib Isi</div>
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_1" style="width: 100%" class="form-control "
                                            name="kabid_1">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_1 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_1')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_2" style="width: 100%" class="form-control "
                                            name="kabid_2">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_2 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_2')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_3" style="width: 100%" class="form-control "
                                            name="kabid_3">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_3 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_3')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_4" style="width: 100%" class="form-control "
                                            name="kabid_4">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_4 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_4')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_5" style="width: 100%" class="form-control "
                                            name="kabid_5">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_5 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_5')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_6" style="width: 100%" class="form-control "
                                            name="kabid_6">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_6 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_6')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_7" style="width: 100%" class="form-control "
                                            name="kabid_7">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_7 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_7')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_8" style="width: 100%" class="form-control "
                                            name="kabid_8">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_8 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_8')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_9" style="width: 100%" class="form-control "
                                            name="kabid_9">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_9 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_9')
                                ...
                                <td>
                                    <div class="mb-2">
                                        <select id="kabid_10" style="width: 100%" class="form-control "
                                            name="kabid_10">
                                            @foreach ($anggota as $item )
                                            <option value="{{$item->id}}" {{$data->kabid_10 == $item->id ? 'selected':''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('kabid_10')
