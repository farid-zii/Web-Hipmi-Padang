...
<div class="main-container">
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            <a class="btn btn-primary no-arrow" href="/dashboard/sektor/create" role="button">
                                Tambah
                            </a>
  ...
  modal</button>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-dark h4">Data Sektor</h4>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" id="myForm" class="d-inline">
                                        @csrf
                                        @method('delete')
                                        <a onclick="hapus('sektor',{{$item->id}})" class="btn btn-danger btn-sm"> <i
